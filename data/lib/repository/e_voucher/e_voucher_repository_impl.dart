...
class EVoucherRepositoryImpl extends EVoucherRepository {
  ...
  @override
  Future<Either<NetworkError, bool>> getVoucherCategories() async {
  ...
  @override
  Future<Either<NetworkError, bool>> getVoucherItemsByCategory(String category) async {
  ...
  @override
  Future<Either<NetworkError, bool>> getVoucherItemsBySearch(String searchText) async {
