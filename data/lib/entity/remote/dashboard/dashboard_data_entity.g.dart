...
DashboardDataEntity _$DashboardDataEntityFromJson(Map<String, dynamic> json) => DashboardDataEntity(
      ...
      blinkJoinedDate:
          json['youJoinedBlink'] == null ? null : DateTime.parse(json['youJoinedBlink'] as String),
      mobileCode: json['mobileCode'] as String? ?? "",
      somethingWrong: json['somethingWrong'] as bool? ?? false,
      debitCardSomethingWrong: json['debitCardSomethingWrong'] as bool? ?? false,
