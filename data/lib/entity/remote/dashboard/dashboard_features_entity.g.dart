...
DashboardFeaturesEntity _$DashboardFeaturesEntityFromJson(Map<String, dynamic> json) =>
    DashboardFeaturesEntity(
      ...
      isCreditCardEnabled: json['blink-retail-app-creditCards-application'] as bool?,
      ...
      blinkRetailAppAliasManagement: json['blink-retail-app-cliq-alias-management'] as bool?,
      blinkRetailAppCliq: json['blink-retail-app-cliq'] as bool?,
      blinkRetailAppCliqSendPayment: json['blink-retail-app-cliq-send-payment'] as bool?,
      blinkRetailAppRTP: json['blink-retail-app-cliq-rtp'] as bool?,
      rtpFeatureEnabled: json['blink-retail-app-cliq-rtp-outward'] as bool?,
      returnPaymentFeatureEnabled: json['blink-retail-app-cliq-return-payment'] as bool?,
      manageContactEnabled: json['blink-retail-app-manage-contacts'] as bool?,
      manageContactHistory: json['blink-retail-app-manage-contacts-History'] as bool?,
...
Map<String, dynamic> _$DashboardFeaturesEntityToJson(DashboardFeaturesEntity instance) => <String, dynamic>{
      ...
      'blink-retail-app-cliq-alias-management': instance.blinkRetailAppAliasManagement,
      'blink-retail-app-cliq-rtp': instance.blinkRetailAppRTP,
      'blink-retail-app-cliq-send-payment': instance.blinkRetailAppCliqSendPayment,
      'blink-retail-app-cliq-rtp-outward': instance.rtpFeatureEnabled,
      'blink-retail-app-cliq-return-payment': instance.returnPaymentFeatureEnabled,
