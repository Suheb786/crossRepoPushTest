...
ContactDetailRequest _$ContactDetailRequestFromJson(Map<String, dynamic> json) => ContactDetailRequest(
...
Map<String, dynamic> _$ContactDetailRequestToJson(ContactDetailRequest instance) => <String, dynamic>{
