...
part 'beneficiary_other_contact_entity.g.dart';

@JsonSerializable()
class BeneficiaryOtherContactEntity
    extends BaseLayerDataTransformer<BeneficiaryOtherContactEntity, BeneficiaryOtherContact> {
  final String? id;
  final String? userId;
  final String? type;
  ...
  factory BeneficiaryOtherContactEntity.fromJson(Map<String, dynamic> json) =>
      _$BeneficiaryOtherContactEntityFromJson(json);

  Map<String, dynamic> toJson() => _$BeneficiaryOtherContactEntityToJson(this);

  @override
  BeneficiaryOtherContact transform() {
    return BeneficiaryOtherContact(
        id: this.id,
        userId: this.userId,
        type: this.type,
