...
BeneficiaryContactEntity _$BeneficiaryContactEntityFromJson(
        Map<String, dynamic> json) =>
    BeneficiaryContactEntity(
      beneficiarySendMoneyContactEntity: json['sm'] == null
          ? null
          : BeneficiarySendMoneyContactEntity.fromJson(
              json['sm'] as Map<String, dynamic>),
      beneficiaryRequestMoneyContactEntity: json['rtp'] == null
          ? null
          : BeneficiaryRequestMoneyContactEntity.fromJson(
              json['rtp'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$BeneficiaryContactEntityToJson(
        BeneficiaryContactEntity instance) =>
    <String, dynamic>{
