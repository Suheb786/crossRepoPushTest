...
part 'beneficiary_transaction_history_entity.g.dart';

@JsonSerializable()
class BeneficiaryTransactionHistoryEntity
    extends BaseLayerDataTransformer<BeneficiaryTransactionHistoryEntity, BeneficiaryTransactionHistory> {
  @JsonKey(
    name: "rmtInf",
    defaultValue: "",
  )
  ...
  factory BeneficiaryTransactionHistoryEntity.fromJson(Map<String, dynamic> json) =>
      _$BeneficiaryTransactionHistoryEntityFromJson(json);

  @override
  BeneficiaryTransactionHistory transform() {
    return BeneficiaryTransactionHistory(
      msgID: this.msgID,
  ...
  Map<String, dynamic> toJson() => _$BeneficiaryTransactionHistoryEntityToJson(this);
}
