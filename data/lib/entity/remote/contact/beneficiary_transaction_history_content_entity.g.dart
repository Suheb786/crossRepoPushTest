...
BeneficiaryTransactionHistoryContentEntity _$BeneficiaryTransactionHistoryContentEntityFromJson(
        Map<String, dynamic> json) =>
    BeneficiaryTransactionHistoryContentEntity(
      date: json['date'] as String? ?? '',
      data: (json['data'] as List<dynamic>?)
              ?.map((e) => BeneficiaryTransactionHistoryEntity.fromJson(e as Map<String, dynamic>))
              .toList() ??
          [],
    );
