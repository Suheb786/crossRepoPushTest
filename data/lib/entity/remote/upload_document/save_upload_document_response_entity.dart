...
class SaveUploadDocumentResponseEntity
    implements BaseLayerDataTransformer<SaveUploadDocumentResponseEntity, SaveUploadDocumentResponse> {
  @JsonKey(name: "response")
  final ResponseEntity? response;

  SaveUploadDocumentResponseEntity({this.response});

  factory SaveUploadDocumentResponseEntity.fromJson(Map<String, dynamic> json) =>
      _$SaveUploadDocumentResponseEntityFromJson(json);

  Map<String, dynamic> toJson() => _$SaveUploadDocumentResponseEntityToJson(this);

  @override
  SaveUploadDocumentResponseEntity restore(SaveUploadDocumentResponse response) {
