...
CustomerStatusEntity _$CustomerStatusEntityFromJson(Map<String, dynamic> json) => CustomerStatusEntity(
      nextScreen: json['nextScreen'] as String?,
      secondNextScreen: json['secondNextScreen'] as String?,
      applicationId: json['applicationId'] as String?,
    );

Map<String, dynamic> _$CustomerStatusEntityToJson(CustomerStatusEntity instance) => <String, dynamic>{
