...
AdditionalIncomeEntity _$AdditionalIncomeEntityFromJson(Map<String, dynamic> json) => AdditionalIncomeEntity(
      id: json['id'] as int?,
...
Map<String, dynamic> _$AdditionalIncomeEntityToJson(AdditionalIncomeEntity instance) => <String, dynamic>{
      'id': instance.id,
