...
ProfileStatusEntity _$ProfileStatusEntityFromJson(Map<String, dynamic> json) => ProfileStatusEntity(
      id: json['id'] as int?,
...
Map<String, dynamic> _$ProfileStatusEntityToJson(ProfileStatusEntity instance) => <String, dynamic>{
      'id': instance.id,
