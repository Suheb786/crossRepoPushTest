...
FatcaCrsEntity _$FatcaCrsEntityFromJson(Map<String, dynamic> json) {
  return FatcaCrsEntity(
    ...
    response1: json['response1'] as String?,
    response2: json['response2'] as String?,
    response3: json['response3'] as String?,
    response4: json['response4'] as String?,
    response5: json['response5'],
    relationshipWithPep: json['relationshipWithPep'],
    personName: json['personName'],
    personRole: json['personRole'],
