...
ValidatePrePaidBillEntity _$ValidatePrePaidBillEntityFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$ValidatePrePaidBillEntityToJson(ValidatePrePaidBillEntity instance) =>
    <String, dynamic>{
