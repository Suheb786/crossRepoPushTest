...
@JsonSerializable()
class GetPostpaidBillerListEntity extends BaseLayerDataTransformer<
    GetPostpaidBillerListEntity, GetPostpaidBillerListModelContent> {
  ...
  GetPostpaidBillerListModelContent transform() {
    return GetPostpaidBillerListModelContent(
       getPostpaidBillerListData:
        this.billList?.map((messages) => GetPostpaidBillerListEntityData.fromJson(messages).transform())
           .toList()
    );
  }
}
