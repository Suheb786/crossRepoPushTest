...
@JsonSerializable()
class CheckOtherNationalityStatusResponseEntity extends BaseLayerDataTransformer<
    CheckOtherNationalityStatusResponseEntity, CheckOtherNationalityResponse> {
  @JsonKey(name: "response")
  final ResponseEntity? response;

  CheckOtherNationalityStatusResponseEntity(this.response);

  factory CheckOtherNationalityStatusResponseEntity.fromJson(Map<String, dynamic> json) =>
      _$CheckOtherNationalityStatusResponseEntityFromJson(json);

  Map<String, dynamic> toJson() => _$CheckOtherNationalityStatusResponseEntityToJson(this);

  @override
  CheckOtherNationalityResponse transform() {
    return CheckOtherNationalityResponse(
        checkOtherNationalityResponseContent:
            CheckOtherNationalityStatusResponseContentEntity.fromJson(this.response!.content).transform());
  }
}
