...
@JsonSerializable()
class RequestCallResponseEntity
    extends BaseLayerDataTransformer<RequestCallResponseEntity, RequestCallStatus> {
  ...
  RequestCallStatus transform() {
    return RequestCallEntity.fromJson(response!.content as Map<String, dynamic>).transform();
  }
}
