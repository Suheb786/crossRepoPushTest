...
class CheckGenderStatusEntity
    implements
        BaseLayerDataTransformer<CheckGenderStatusEntity, AgentGenderStatus> {
  ...
  CheckGenderStatusEntity(
      {this.isMaleAvailable: false, this.isFemaleAvailable: false});
  ...
  AgentGenderStatus transform() {
    return AgentGenderStatus(
        isExist: (isMaleAvailable ?? false) || (isFemaleAvailable ?? false));
  }
}
