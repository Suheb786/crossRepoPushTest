...
@JsonSerializable()
class RequestMoneyActivityEntity extends BaseLayerDataTransformer<
    RequestMoneyActivityEntity, RequestMoneyActivity> {
  ...
  RequestMoneyActivity transform() {
    return RequestMoneyActivity(
      this.requestMoneyActivities?.map((e) => e.transform()).toList() ??
          List.empty(),
    );
  }
}
