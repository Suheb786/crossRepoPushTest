...
@JsonSerializable()
class GetAliasEntity
    extends BaseLayerDataTransformer<GetAliasEntity, GetAlias> {
  ...
  factory GetAliasEntity.fromJson(Map<String, dynamic> json) =>
      _$GetAliasEntityFromJson(json);
