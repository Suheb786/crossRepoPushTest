...
AliasListEntity _$AliasListEntityFromJson(Map<String, dynamic> json) => AliasListEntity(
...
Map<String, dynamic> _$AliasListEntityToJson(AliasListEntity instance) => <String, dynamic>{
