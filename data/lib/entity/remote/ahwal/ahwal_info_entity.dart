...
@JsonSerializable()
class AhwalInfoEntity implements BaseLayerDataTransformer<AhwalInfoEntity, AhwalInfo> {
  ...
  factory AhwalInfoEntity.fromJson(Map<String, dynamic> json) => _$AhwalInfoEntityFromJson(json);
