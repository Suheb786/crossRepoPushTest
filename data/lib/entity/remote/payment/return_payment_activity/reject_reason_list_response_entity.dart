...
class RejctReasonListEntity extends BaseLayerDataTransformer<RejctReasonListEntity, RejectReasonsPayment> {
  ...
  factory RejctReasonListEntity.fromJson(Map<String, dynamic> json) =>
      _$RejctReasonListResponseEntityFromJson(json);

  Map<String, dynamic> toJson() => _$RejctReasonListResponseEntityToJson(this);
