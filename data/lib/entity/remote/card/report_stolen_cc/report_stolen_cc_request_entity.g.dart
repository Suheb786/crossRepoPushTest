...
ReportStolenCCRequestEntity _$ReportStolenCCRequestEntityFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$ReportStolenCCRequestEntityToJson(ReportStolenCCRequestEntity instance) =>
    <String, dynamic>{
