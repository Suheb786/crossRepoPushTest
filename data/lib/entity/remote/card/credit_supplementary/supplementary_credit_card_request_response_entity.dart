...
@JsonSerializable()
class SupplementaryCreditCardRequestResponseEntity extends BaseLayerDataTransformer<
    SupplementaryCreditCardRequestResponseEntity, SupplementaryCreditCardResponse> {
  @JsonKey(name: "response")
  final ResponseEntity? response;

  SupplementaryCreditCardRequestResponseEntity({this.response});

  factory SupplementaryCreditCardRequestResponseEntity.fromJson(Map<String, dynamic> json) =>
      _$SupplementaryCreditCardRequestResponseEntityFromJson(json);

  Map<String, dynamic> toJson() => _$SupplementaryCreditCardRequestResponseEntityToJson(this);

  @override
  SupplementaryCreditCardResponse transform() {
    return SupplementaryCreditCardResponse(
        content:
            SupplementaryCreditCardReqResponseContentEntity.fromJson(this.response!.content).transform());
  }
}
