...
SupplementaryCreditCardRequestResponseEntity _$SupplementaryCreditCardRequestResponseEntityFromJson(
    Map<String, dynamic> json) {
  return SupplementaryCreditCardRequestResponseEntity(
    response:
