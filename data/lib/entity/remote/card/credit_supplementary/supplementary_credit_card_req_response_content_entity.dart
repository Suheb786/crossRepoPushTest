...
@JsonSerializable()
class SupplementaryCreditCardReqResponseContentEntity
    extends BaseLayerDataTransformer<
        SupplementaryCreditCardReqResponseContentEntity,
        SupplementaryCreditCardRequestContent> {
  ...
  SupplementaryCreditCardReqResponseContentEntity(
      {this.primaryId: "", this.suppId: ""});

  factory SupplementaryCreditCardReqResponseContentEntity.fromJson(
          Map<String, dynamic> json) =>
      _$SupplementaryCreditCardReqResponseContentEntityFromJson(json);

  Map<String, dynamic> toJson() =>
      _$SupplementaryCreditCardReqResponseContentEntityToJson(this);

  @override
  SupplementaryCreditCardRequestContent transform() {
    return SupplementaryCreditCardRequestContent(
        primaryId: this.primaryId ?? '', suppId: this.suppId ?? '');
  }
}
