...
CustomerDetailsEntity _$CustomerDetailsEntityFromJson(
  ...
  return CustomerDetailsEntity(
    ...
    relationshipPep: json['relationshipPep'],
    namePep: json['namePep'],
    rolePep: json['rolePep'],
    beneficialOwner: json['beneficialOwner'],
    districtCorresp: json['districtCorresp'],
    addressLine1: json['addressLine1'],
    spouseName: json['spouseName'],
    specialNeedsPerson: json['specialNeedsPerson'],
    natureofSpecialNeeds: json['natureofSpecialNeeds'],
    employmentStatus: json['employmentStatus'],
    occupation: json['occupation'] as String?,
    mainSourceofIncome: json['mainSourceofIncome'],
    otherEmploymentStatus: json['otherEmploymentStatus'],
    annualIncome: json['annualIncome'] as int?,
    monthlyIncome: (json['monthlyIncome'] as num?)?.toDouble(),
    additionalIncomeSource: json['additionalIncomeSource'],
    otherAdditionalIncomeSource: json['otherAdditionalIncomeSource'],
    additionalIncomeAmount: json['additionalIncomeAmount'] as int?,
    employerPhone: json['employerPhone'],
    reasonforBanking: json['reasonforBanking'],
    ...
    empCountry: json['empCountry'],
    empState: json['empState'],
    empCity: json['empCity'],
  );
}
