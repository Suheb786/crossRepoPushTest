...
AccountDetailsEntity _$AccountDetailsEntityFromJson(Map<String, dynamic> json) {
  return AccountDetailsEntity(
    ...
    noOfDrTrx: json['noOfDrTrx'] as int?,
    noOfCrTrx: json['noOfCrTrx'] as int?,
    drThresholdLimit: (json['drThresholdLimit'] as num?)?.toDouble(),
    crThresholdLimit: (json['crThresholdLimit'] as num?)?.toDouble(),
