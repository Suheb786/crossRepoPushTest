...
class _ApiService implements ApiService {
  ...
  Future<HttpResponse<VoucherFilterResponseEntity>> getVoucherItemsByFilter(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'http://10.6.13.2:2186/Voucher/api/Vouchers/GetItemsByFilter',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  @override
  Future<HttpResponse<bool>> placeOrder(PlaceOrderRequestEntity request) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<HttpResponse<bool>> eVoucherOtp(BaseRequest request) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
