...
class _ApiService implements ApiService {
  ...
  Future<HttpResponse<CountryListResponseEntity>> getCountryList(countryListRequestEntity) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<CountryListResponseEntity>>(Options(
                method: 'POST', headers: <String, dynamic>{}, extra: _extra)
            .compose(_dio.options, '/transfer/GetCountriesV2', queryParameters: queryParameters, data: _data)
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  @override
  Future<HttpResponse<FlightDetailsResponseEntity>> getFlightDetails(request) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(request.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<FlightDetailsResponseEntity>>(
            Options(method: 'POST', headers: <String, dynamic>{}, extra: _extra)
