...
final applyCreditCardHomeViewModelProvider = ChangeNotifierProvider.autoDispose<ApplyCreditCardHomeViewModel>(
  (ref) => ApplyCreditCardHomeViewModel(),
);

final setCreditLimitViewModelProvider = ChangeNotifierProvider.autoDispose<SetCreditLimitViewModel>(
  (ref) =>
      SetCreditLimitViewModel(ref.read(setCreditLimitUseCaseProvider), ref.read(getLoanValueUseCaseProvider)),
);
...
final creditCardActivationViewModelProvider =
  ...
  (ref) => CreditCardActivationStatusPageViewModel(
      ...
      ref.read(processLoanStepUseCaseProvider)),
);

final supplementaryCreditCardActivationViewModelProvider = ChangeNotifierProvider.autoDispose
    .family<SupplementaryCreditCardActivationStatusPageViewModel, SupplementaryCreditCardActivationArguments>(
