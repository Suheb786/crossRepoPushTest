...
final getGenerateBlockPinUseCaseProvider = Provider.autoDispose<GenerateBlockPinUseCase>(
...
final getDecryptedCardNumberUseCaseProvider =
    Provider.autoDispose<DecryptCardUseCase>((ref) => DecryptCardUseCase(ref.read(cardProcessingRepository)));
