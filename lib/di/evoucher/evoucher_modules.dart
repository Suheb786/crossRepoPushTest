...
final eVouchersDialogViewModelProvider =
    ChangeNotifierProvider.autoDispose<EVouchersFilterDialogViewModel>(
...
final purchaseEVouchersViewModelProvider =
    ChangeNotifierProvider.autoDispose<PurchaseEVoucherPageViewModel>(
...
final selectAccountViewModelProvider =
    ChangeNotifierProvider.autoDispose<SelectAccountPageViewModel>((ref) =>
        SelectAccountPageViewModel(ref.read(selectAccountUseCaseProvider)));
...
final enterOtpForEVoucherCategoryPurchaseViewModelProvider =
    ChangeNotifierProvider.autoDispose<
        ...
        (ref) => EnterOtpForEVoucherCategoryPurchasePageViewModel(ref
            .read(enterOtpForEVoucherCategoryPurchaseUseCaseUseCaseProvider)));
...
final shareVoucherViewModelProvider =
    ChangeNotifierProvider.autoDispose<ShareVoucherPageViewModel>(
        (ref) => ShareVoucherPageViewModel());
...
final enterCodeEVoucherPurchaseViewModelProvider =
    ChangeNotifierProvider.autoDispose<EnterCodeEVoucherPurchasePageViewModel>(
        (ref) => EnterCodeEVoucherPurchasePageViewModel(
            ref.read(enterCodeEVoucherPurchaseUseCaseProvider)));
