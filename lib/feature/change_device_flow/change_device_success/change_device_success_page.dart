...
class ChangeDeviceSuccessPage
    extends BasePage<ChangeDeviceSuccessPageViewModel> {
  @override
  ChangeDeviceSuccessPageState createState() => ChangeDeviceSuccessPageState();
}

class ChangeDeviceSuccessPageState extends BaseStatefulPage<
    ChangeDeviceSuccessPageViewModel, ChangeDeviceSuccessPage> {
  @override
  ...
  @override
  Widget buildView(
      BuildContext context, ChangeDeviceSuccessPageViewModel model) {
