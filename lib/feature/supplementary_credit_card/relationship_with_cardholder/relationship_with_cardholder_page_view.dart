...
class RelationshipWithCardholderPageView extends BasePageViewWidget<RelationshipWithCardholderPageViewModel> {
  RelationshipWithCardholderPageView(ProviderBase model) : super(model);

  @override
  Widget build(BuildContext context, RelationshipWithCardholderPageViewModel model) {
