...
import 'edit_contact_details_otp_page_view_model.dart';

class EditUserDetailsOtpForManageContactPageView extends BasePageViewWidget<EditUserContactotpViewModel> {
  EditUserDetailsOtpForManageContactPageView(ProviderBase model) : super(model);
