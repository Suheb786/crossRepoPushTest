...
class AddBeneficiaryFormPageView
    extends BasePageViewWidget<AddBeneficiaryFormPageViewModel> {
              ...
              child: AppStreamBuilder<Resource<SendOtpAddBeneficiaryResponse>>(
                  ...
                  onData: (value) {
                    if (value.status == Status.SUCCESS) {
                      model.mobileNumber =
                          value.data?.sendOTPAddBeneficiary?.mobileNumber ?? '';
                      model.mobileCode =
                          value.data?.sendOTPAddBeneficiary?.mobileCode ?? '';
                  ...
                  dataBuilder: (context, validate) {
                    return AppStreamBuilder<Resource<CheckSendMoneyResponse>>(
                        ...
                        onData: (value) {
                          if (value.status == Status.SUCCESS) {
                            if (value.data?.checkSendMoneyContent
                                    ?.transferResponse?.messageEnum ==
                                CheckSendMoneyMessageEnum
                                    .Mobile_NUMBER_BANKSMART) {
                                    ...
                                    Expanded(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          Focus(
                                            child: AppTextField(
                                              labelText: model.navigationType ==
                                                      NavigationType
                                                          .REQUEST_MONEY
                                                  ? S.current
                                                      .accountMobileNoCliQ
                                              ...
                                              hintText: S.current.pleaseEnter,
                                              controller:
                                                  model.ibanOrMobileController,
                                              key: model
                                                  .ibanORaccountORmobileORaliasKey,
                                              onChanged: (value) {
                                                if (value.isEmpty) {
                                                  model.showNameVisibility('');
                                                  model.ibanFieldValidated =
                                                      false;
                                                }
                                                model.validate();
                                              },
                                                        ...
                                                        descriptionWidget:
                                                          ...
                                                          children: [
                                                            Text(
                                                              S
                                                                  .of(context)
                                                                  .manageContactSendRequestSample,
                                                              style: TextStyle(
                                                                  fontFamily:
                                                                      StringUtils
                                                                          .appFont,
