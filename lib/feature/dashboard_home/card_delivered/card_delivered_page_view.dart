...
class CardDeliveredPageView extends BasePageViewWidget<CardDeliveredViewModel> {
  CardDeliveredPageView(ProviderBase model) : super(model);
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            Padding(
                              padding:
                                  EdgeInsets.only(top: 78, left: 30, right: 24),
                              child: Text(
