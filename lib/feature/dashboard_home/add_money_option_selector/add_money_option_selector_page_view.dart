...
class AddMoneyOptionSelectorPageView
  ...
  Widget build(BuildContext context, model) {
    return AppStreamBuilder<Resource<Stream<User>>>(
        ...
        dataBuilder: (context, userStream) {
          return AppStreamBuilder<User>(
              initialData: User(),
              stream: userStream!.data!,
              onData: (data) {},
                            ...
                            child: Column(
                              children: [
                                ...
                                AddMoneySelectorOptionsWidget(
                                  ...
                                  title:
                                      S.of(context).requestMoneyFromOtherBank,
                                  desc: S
                                      .of(context)
                                ...
                                AppStreamBuilder<GetDashboardDataContent>(
                                  ...
                                  dataBuilder: (context, cardData) {
                                    return AddMoneySelectorOptionsWidget(
                                      ...
                                      title:
                                          S.of(context).receiveMoneyFromOthers,
                                      desc: S
                                          .of(context)
                                          .receiveMoneyFromOthersDesc,
                                      buttonText:
                                          S.of(context).shareAccountInfo,
                                      onTap: () {
                                        _shareFiles(
                                            model, context, user, cardData);
                                      },
                                    );
                                  },
                                ),
