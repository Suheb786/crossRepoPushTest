      ...
      child: AppStreamBuilder<Resource<RequestToPayContentResponse>>(
          ...
          onData: (data) async {
            if (data.status == Status.ERROR) {
              ...
              await FireBaseLogUtil.fireBaseLog("request_money_saved_beneficiary_failure", {"is_money_requested": false});
            } else if (data.status == Status.SUCCESS) {
              ///LOGGING EVENT TO APP FLYER
              model.logEventsForAppFlyer(eventName: 'request_money_from_contact', eventValue: {"money_requested": model.currentPinValue});

              ///LOG EVENT TO FIREBASE
              await FireBaseLogUtil.fireBaseLog("request_money_saved_beneficiary_success", {"is_money_requested": true, "money_requested": model.currentPinValue});
                      ...
                      children: [
                          ...
                          child: model.beneficiary!.imageUrl.isNotEmpty
                              ...
                              : CircleAvatar(
                                  ...
                                  child: Text(
                                    ...
                                    style: TextStyle(fontFamily: StringUtils.appFont, fontWeight: FontWeight.w700, fontSize: 20.t, color: Theme.of(context).colorScheme.secondary),
                                  ),
                                ),
                        ),
                        Padding(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                ProviderScope.containerOf(context).read(appHomeViewModelProvider).dashboardDataContent.account!.availableBalance!.toString(),
                                style: TextStyle(
                                  fontFamily: StringUtils.appFont,
