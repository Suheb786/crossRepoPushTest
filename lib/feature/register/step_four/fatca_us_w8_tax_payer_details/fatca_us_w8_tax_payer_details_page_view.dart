                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      AppTextField(
                                        ...
                                        readOnly: true,
                                        onPressed: () {
                                          TaxPayerDialog.show(context, taxPayerTypeEnum: TaxPayerTypeEnum.W8,
                                              onDismissed: () {
                                                    ...
                                                    dataBuilder: (context, isVisible) {
                                                      return (isVisible!)
                                                          ...
                                                          : AppTextField(
                                                              ...
                                                              hintText: S.of(context).pleaseEnter,
                                                              controller:
                                                                  model.foreignIdentificationNumberController,
                                          ...
                                          return Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                InkWell(
                                                  onTap: () {
                                                    Navigator.pushNamed(context, RoutePaths.TaxTreatyBenefits,
                                                ...
                                                Visibility(
                                                  ...
                                                  child: Column(
                                                    children: [
                                                      ...
                                                      AppTextField(
                                                        labelText: S.of(context).provisionClaim.toUpperCase(),
                                                        hintText: S.of(context).pleaseSelect,
