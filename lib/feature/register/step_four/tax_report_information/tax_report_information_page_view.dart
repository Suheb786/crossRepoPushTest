...
class TaxReportInformationPageView extends BasePageViewWidget<TaxReportInformationPageViewModel> {
                        ...
                        child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                            ...
                                            return InkWell(
                                              onTap: () async {
                                                CountryDialog.show(context,
                                                  ...
                                                  Navigator.pop(context);
                                                  model.countrySelectorController.text = value.countryName!;
                                              ...
                                              children: [
                                                Padding(
                                                  ...
                                                  child: AppSwitchLabelWidget(
                                                    label: S.of(context).doYouHaveTinAvailable,
                                                    ...
                                                    onToggle: (value) {
                                                      ...
                                                      model.explainReasonController.clear();
                                                      model.tinController.clear();
                                                      model.updateExplainReasonVisibility(false);
                                                      model.updateValidateFieldValue(false);
                                                    },
                                                    isActive: isActive,
                                                  ),
                                                ),
                                                ...
                                                Visibility(
                                                  visible: !isActive,
                                                  child: AppTextField(
                                                    labelText: S.of(context).reasonOfUnavailability,
                                                    hintText: S.of(context).pleaseSelect,
                                                    ...
                                                    suffixIcon: (value, data) {
                                                      return InkWell(
                                                        onTap: () async {
                                                          ReasonOfUnavailabilityDialog.show(context,
                                                              onSelected: (value) {
                                                            Navigator.pop(context);
                                                            model.updateReasonControllerField(value);
                                                            model.validateFields();
                                                          });
                                                        },
                                                        child: Container(
                                                  ...
                                                  dataBuilder: (context, isVisible) {
                                                    return Visibility(
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: AppTextField(
                                                          labelText: S.of(context).explainReason,
                                                          hintText: S.of(context).pleaseEnter,
                                                          key: model.explainReasonKey,
                                                          controller: model.explainReasonController,
                                                          onChanged: (value) {
                                                            model.validateFields();
                                                          },
                                                        ),
                                ...
                                Column(
                                  children: [
                                    InkWell(onTap: () {}, child: AppSvg.asset(AssetUtils.saveAndExit)),
                                    Padding(
                                      padding: const EdgeInsets.only(right: 45, top: 24),
                                      child: AppStreamBuilder<bool>(
