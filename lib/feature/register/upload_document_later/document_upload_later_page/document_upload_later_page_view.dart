...
class DocumentUploadLaterPageView extends BasePageViewWidget<DocumentUploadLaterPageViewModel> {
  DocumentUploadLaterPageView(ProviderBase model) : super(model);
                                                                    ...
                                                                    child: TextButton(
                                                                        onPressed: () {
                                                                          UploadDocumentLaterDialog.show(
                                                                            ...
                                                                            print(
                                                                                'documentSkipped:-->${model.isDocumentSkipped}');
                                                                            model.getCustomerStatus();
                                                                            // // model.getAccount();
  ...
  void getNextPage(
      CustomerStatus customerStatus, DocumentUploadLaterPageViewModel model, BuildContext context) {
