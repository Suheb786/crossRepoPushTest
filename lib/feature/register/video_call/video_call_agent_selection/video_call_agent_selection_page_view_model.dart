...
class VideoCallAgentSelectionPageViewModel extends BasePageViewModel {
  ...
  BehaviorSubject<Resource<RequestCallStatus>> _requestCallResponse = BehaviorSubject();
  ...
  VideoCallAgentSelectionPageViewModel(this._checkGenderStatusUseCase, this._requestCallUseCase,
