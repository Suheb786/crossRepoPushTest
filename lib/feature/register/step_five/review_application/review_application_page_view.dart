                ...
                return ShakeAnimatedWidget(
                  ...
                  child: AppStreamBuilder<Resource<List<String>>>(
                    ...
                    dataBuilder: (context, response) {
                      return AppStreamBuilder<Resource<CheckVideoCallResponse>>(
                        stream: model.checkVideoCallStream,
                        initialData: Resource.none(),
                        onData: (data) {
                          ///TODO: based  on videocall status initiate videocall
                          if (data.status == Status.SUCCESS) {
                            print(
                                'video call status--->${data.data!.checkVideoCallResponseContent!.status}');
                          }
                        },
                                  ...
                                  child: SingleChildScrollView(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        ReviewApplicationEditableItem(
                                          title:
                                              S.of(context).streetAddressSmall,
                                          controller:
                                        ...
                                        ReviewApplicationEditableItem(
                                          title:
                                              S.of(context).employerNameSmall,
                                          controller:
                                        ...
                                        ReviewApplicationEditableItem(
                                          title:
                                              S.of(context).employerCitySmall,
                                          controller:
                                        ...
                                        ReviewApplicationNonEditableItem(
                                          title:
                                              S.of(context).areYouUSTaxResident,
                                          value: "No",
                                        ),
                                        ReviewApplicationNonEditableItem(
                                        ...
                                        ReviewApplicationNonEditableItem(
                                          title:
                                              S.of(context).areYouTaxResidentQ,
                                          value: "No",
                                        ),
                                        ReviewApplicationNonEditableItem(
                                          title: S
