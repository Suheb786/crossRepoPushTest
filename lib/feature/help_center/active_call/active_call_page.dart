...
class ActiveCallPage
    extends BasePage<ActiveCallPageViewModel> {
  @override
  ActiveCallPagePageState createState() =>
      ActiveCallPagePageState();
}

class ActiveCallPagePageState extends BaseStatefulPage<
    ActiveCallPageViewModel, ActiveCallPage> {
  @override
  ...
  @override
  Widget buildView(
      BuildContext context, ActiveCallPageViewModel model) {
