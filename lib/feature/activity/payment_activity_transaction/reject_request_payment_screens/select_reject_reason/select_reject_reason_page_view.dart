      ...
      child: AppStreamBuilder<bool>(
          ...
          dataBuilder: (context, isError) {
            return ShakeAnimatedWidget(
                ...
                child: AppStreamBuilder<Resource<List<RejectionReasonInward>>>(
                            ...
                            return GestureDetector(
                              ...
                              child: Card(
                                ...
                                child: Padding(
                                  ...
                                  child: Container(
                                      padding:
                                          EdgeInsets.only(left: 24.w, right: 24.w, top: 25.h, bottom: 16.h),
                                      child: Column(
                                              ...
                                              child: Column(
                                                children: [
                                                  AppTextField(
                                                    ...
                                                    readOnly: true,
                                                    onPressed: () {
                                                      if (reasonToRejectResponse?.status == Status.SUCCESS &&
                                                          reasonToRejectResponse?.data != null) {
                                                        bool status =
                                                            (reasonToRejectResponse?.data?.isNotEmpty) ??
                                                                false;
                                                        if (status) {
                                                          RejectReasonInwardRequestDialog.show(context,
                                                              title:
                                                                  S.of(context).reasonToReject.toUpperCase(),
                                                              rejectionReasonInward: reasonToRejectResponse!
                                                                  .data!, onDismissed: () {
                                                            Navigator.pop(context);
                                                          }, onSelected: (value) {
                                                            Navigator.pop(context);
