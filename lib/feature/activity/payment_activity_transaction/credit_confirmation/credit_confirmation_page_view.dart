...
class CreditConfirmationPaymentActivityPageView
  ...
  Widget build(BuildContext context, model) {
    return AppStreamBuilder<Resource<CreditConfirmation>>(
        stream: model.creditConfirmation,
        initialData: Resource.none(),
        onData: (creditConfirmationResponseData) async {
          if (creditConfirmationResponseData.status == Status.SUCCESS) {
            if (creditConfirmationResponseData.data != null) {
              model.shareFiles(context, await creditConfirmationResponseData.data!.pdf);
            }
          }
        },
        dataBuilder: (context, creditConfirmationResponse) {
          return Container(
                      ...
                      child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              GestureDetector(
                                onTap: () {
                                  model.makeCreditConfirmationRequest(
                                      msgId: model.creditConfirmationArgument.msgID ?? '');
                                },
                                child: Container(
                                  width: double.infinity,
                                  decoration: BoxDecoration(
