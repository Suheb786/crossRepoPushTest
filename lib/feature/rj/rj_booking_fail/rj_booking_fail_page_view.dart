...
class RJBookingFailurePageView extends BasePageViewWidget<RJBookingFailurePageViewModel> {
  RJBookingFailurePageView(ProviderBase model) : super(model);

  @override
  Widget build(BuildContext context, RJBookingFailurePageViewModel model) {
