...
class PayAllPostPaidBillsPageView extends BasePageViewWidget<PayAllPostPaidBillsPageViewModel> {
                            ...
                            Padding(
                              ...
                              child: Stack(
                                ...
                                children: [
                                  Expanded(
                                    child: Text(
                                      model.arguments.paidBillsPayTypeOptionEnum == PostPaidBillsPayTypeOptionEnum.PAYALLBILLS ? S.of(context).viewAndPayYourDueBills : S.of(context).myBills,
                                  ...
                                  model.arguments.paidBillsPayTypeOptionEnum == PostPaidBillsPayTypeOptionEnum.PAYALLBILLS
                                      ? Padding(
                                      ...
                                      : Container(),
                                  Visibility(
                                    visible: model.arguments.paidBillsPayTypeOptionEnum == PostPaidBillsPayTypeOptionEnum.PAYALLBILLS ? false : true,
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(color: AppColor.white, borderRadius: BorderRadius.only(topLeft: Radius.circular(16), topRight: Radius.circular(16))),
                                      child: Padding(
                                          padding: EdgeInsetsDirectional.only(top: 24.0.h),
                                          child: Column(
                                            children: [
                                              ...
                                              model.arguments.paidBillsPayTypeOptionEnum == PostPaidBillsPayTypeOptionEnum.PAYALLBILLS || model.payPostPaidBillsDataList.length <= 0
                                                  ? Container()
                                                  : Padding(
                                                      padding: EdgeInsetsDirectional.only(start: 50.0, end: 50.0, top: 16.0, bottom: 16.0),
                                                      child: Container(
                                                        padding: EdgeInsets.symmetric(horizontal: 16.0.w, vertical: 8.0.h),
                                                        decoration: BoxDecoration(color: AppColor.lightGray, borderRadius: BorderRadius.all(Radius.circular(8.0))),
                                                        child: Row(
                                                          ...
                                                          children: [
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: Text(
                                                                ...
                                                                style: TextStyle(fontFamily: StringUtils.appFont, color: AppColor.very_dark_gray1, fontWeight: FontWeight.w400, fontSize: 12.0.t),
                                                              ),
                                                            ),
                                                          ],
                                                        ),
                                              ...
                                              model.arguments.paidBillsPayTypeOptionEnum == PostPaidBillsPayTypeOptionEnum.PAYALLBILLS ? Container() : AppDivider(),
                                              Expanded(
                                                child: Padding(
                                                  padding: EdgeInsetsDirectional.only(top: model.arguments.paidBillsPayTypeOptionEnum == PostPaidBillsPayTypeOptionEnum.PAYALLBILLS ? 24.0.h : 8.0.h, bottom: 24.0.h),
                                                  child: model.payPostPaidBillsDataList.length > 0
                                                      ? ListView.separated(
                                                          ...
                                                          itemBuilder: (context, index) {
                                                            return InkWell(
                                                              onTap: () {
                                                                if (model.isDisabledConditions(model.payPostPaidBillsDataList[index])) {
                                                                  showErrorMethod(context, model, index);
                                                                } else {
                                                                  showErrorMessageForPartialBillMethod(model, index);
                                                                }
                                                                if (!model.payPostPaidBillsDataList[index].noDataFoundForBill) {
                                                                  model.selectedItem(index, true);
                                                                } else {
                                                                  model.showToastWithError(AppError(error: ErrorInfo(message: ''), type: ErrorType.NETWORK, cause: Exception()));
                                                                }
                                                              },
                                                              child: model.arguments.paidBillsPayTypeOptionEnum == PostPaidBillsPayTypeOptionEnum.PAYALLBILLS
                                                                  ? PayBillsMultipleListSelectionWidget(
                                                                      icon: model.payPostPaidBillsDataList[index].iconCode ?? "",
                                                                      isPartial: model.payPostPaidBillsDataList[index].isPartial ?? false,
                                                                      isDisabled: model.isDisabledConditions(model.payPostPaidBillsDataList[index]),
                                                                      maxValue: double.parse(model.payPostPaidBillsDataList[index].maxValue ?? "0").toStringAsFixed(3),
                                                                      biller: StringUtils.isDirectionRTL(context)
                                                                          ? model.payPostPaidBillsDataList[index].billerNameAR ?? ""
                                                                          : model.payPostPaidBillsDataList[index].billerNameEN ?? "",
                                                                      billAmtDue: double.parse(model.payPostPaidBillsDataList[index].actualdueAmountFromApi ?? "0").toStringAsFixed(3),
                                                                      fees: double.parse(model.payPostPaidBillsDataList[index].fees ?? "0").toStringAsFixed(3),
                                                                      isSelected: model.payPostPaidBillsDataList[index].isChecked ?? false,
                                                                      nickName: model.payPostPaidBillsDataList[index].nickName ?? "",
                                          ...
                                          child: Padding(
                                            ...
                                            child: InkWell(
                                              onTap: () {
                                                ...
                                                tempSelectedPostPaidBillsList = model.payPostPaidBillsDataList.where((element) => ((element.isChecked ?? false) && !model.isDisabledConditions(element))).toList();

                                                tempSelectedPostPaidBillsList = tempSelectedPostPaidBillsList.toSet().toList();

                                                for (var payPostPaidBillsDataListItem in tempSelectedPostPaidBillsList) {
                                                  for (var item in model.postPaidBillInquiryData!) {
                                                    ...
                                                    if (item.billingNo == payPostPaidBillsDataListItem.billingNo &&
                                                        item.serviceType == payPostPaidBillsDataListItem.serviceType &&
                                                        payPostPaidBillsDataListItem.isAmountUpdatedFromApi == true) {
                                                      dueAmt = double.parse(payPostPaidBillsDataListItem.actualdueAmountFromApi ?? "0");
                                                    }

                                                    if (dueAmt > 0.0 || dueAmt == 0.0 && item.isPartial == true && double.parse(item.maxValue ?? "0") > 0.0 || item.success == true) {
                                                      ...
                                                      if (item.billingNo != null && item.billingNo!.isNotEmpty && item.serviceType != null && item.serviceType!.isNotEmpty) {
                                                        if (payPostPaidBillsDataListItem.billingNo == item.billingNo &&
                                                            payPostPaidBillsDataListItem.serviceType == item.serviceType &&
                                                ...
                                                for (var item in tempSelectedPostPaidBillsList) {
                                                  if (item.isChecked == false) {
                                                    temPostPaidBillInquiryData.removeWhere((element) => element.billingNo == item.billingNo && element.serviceType == item.serviceType);
                                                    tempSelectedPostPaidBillsList.removeWhere((element) => element.billingNo == item.billingNo && element.serviceType == item.serviceType);
                                                  }
                                                ...
                                                if (temPostPaidBillInquiryData.isNotEmpty && temPostPaidBillInquiryData.isNotEmpty) {
                                                  Navigator.pushNamed(context, RoutePaths.PaySelectedBillsPostPaidBillsPage,
                                                      arguments: PaySelectedBillsPostPaidBillsPageArguments(
                                                          model.postPaidBillInquiryData!.length.toString(), amt ?? 0.0, tempSelectedPostPaidBillsList, temPostPaidBillInquiryData));
                                                } else {
                                                  model.showToastWithError(AppError(cause: Exception(), error: ErrorInfo(message: ""), type: ErrorType.SELECT_AT_LEAST_ONE_BILL));
                                                }
                                              },
                                              child: Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  ...
                                                  color: model.payPostPaidBillsDataList.isEmpty
                                                      ...
                                                      : (model.payPostPaidBillsDataList.any((item) => item.isChecked == true && !model.isDisabledConditions(item)))
                                                          ? Theme.of(context).textTheme.bodyLarge!.color!
                                                          : AppColor.very_dark_gray1.withOpacity(0.5),
                                                ),
                                                child: Center(
                                                  child: Text(
                                                      S.of(context).pay + " " + "${amt == null || amt.toString().isEmpty ? double.parse("0").toStringAsFixed(3) : amt.toStringAsFixed(3)}" + " " + S.of(context).JOD,
                                                      maxLines: 1,
                                                      style: TextStyle(fontFamily: StringUtils.appFont, fontSize: 14.t, fontWeight: FontWeight.w600, letterSpacing: 1, color: Theme.of(context).colorScheme.secondary)),
                                                ),
                                              ),
                                            ),
                                          ),
  ...
  void showErrorMessageForPartialBillMethod(PayAllPostPaidBillsPageViewModel model, int index) {
    if (double.parse(model.payPostPaidBillsDataList[index].actualdueAmountFromApi ?? "0") <= 0.0 &&
      ...
      if (model.payPostPaidBillsDataList[index].isPartial == true && double.parse(model.payPostPaidBillsDataList[index].maxValue ?? "0") > 0.0) {
        model.showToastWithError(AppError(cause: Exception(), error: ErrorInfo(message: ''), type: ErrorType.THERE_ARE_NO_DUE_BILLS_BUT_CAN_MAKE_PARTIAL_PAYMENTS));
      }
    }
    ...
    ///To show error message for bill where due amount is equal to fees amount
        ...
        double.parse(model.payPostPaidBillsDataList[index].actualdueAmountFromApi ?? "0") == double.parse(model.payPostPaidBillsDataList[index].fees ?? "0") &&
        model.payPostPaidBillsDataList[index].isChecked == false) {
      if (model.payPostPaidBillsDataList[index].isPartial == true && double.parse(model.payPostPaidBillsDataList[index].maxValue ?? "0") > 0.0) {
        model.showToastWithError(AppError(cause: Exception(), error: ErrorInfo(message: ''), type: ErrorType.THERE_ARE_NO_DUE_BILLS_BUT_CAN_MAKE_PARTIAL_PAYMENTS));
      }
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(message, style: TextStyle(color: Theme.of(context).colorScheme.secondary, fontWeight: FontWeight.w600, fontSize: 12)),
                        ),
                      ],
                    ),
                  ),
  ...
  void showErrorMethod(BuildContext context, PayAllPostPaidBillsPageViewModel model, int index) {
    if (model.payPostPaidBillsDataList[index].expDateStatus == false) {
      if (model.payPostPaidBillsDataList[index].expDateMessage != null && model.payPostPaidBillsDataList[index].expDateMessage!.toString().isNotEmpty) {
        if (model.payPostPaidBillsDataList[index].expDateMessage == "err-379") {
          model.showToastWithError(AppError(cause: Exception(), error: ErrorInfo(message: ''), type: ErrorType.EXPIRY_DATE_SAVED_BILL_CHECK_MESSAGE));
        } else if (model.payPostPaidBillsDataList[index].expDateMessage == "err-381") {
          model.showToastWithError(AppError(cause: Exception(), error: ErrorInfo(message: ''), type: ErrorType.OPEN_DATE_ISSUE_MESSAGE));
        } else if (model.payPostPaidBillsDataList[index].expDateMessage == "err-383") {
          model.showToastWithError(AppError(cause: Exception(), error: ErrorInfo(message: ''), type: ErrorType.CLOSE_DATE_SAVED_BILL_CHECK_MESSAGE));
        } else {
          if (double.parse(model.payPostPaidBillsDataList[index].actualdueAmountFromApi ?? "0") <= 0.0) {
            model.showToastWithError(AppError(error: ErrorInfo(message: ''), type: ErrorType.NETWORK, cause: Exception()));
          }
      ...
      if (double.parse(model.payPostPaidBillsDataList[index].actualdueAmountFromApi ?? "0") <= 0.0) {
        if (model.payPostPaidBillsDataList[index].isPartial == false) {
          model.showToastWithError(AppError(cause: Exception(), error: ErrorInfo(message: ''), type: ErrorType.THERE_ARE_NO_DUE_BILLS));
        } else {
          model.showToastWithError(AppError(cause: Exception(), error: ErrorInfo(message: ''), type: ErrorType.THERE_ARE_NO_DUE_BILLS_BUT_CAN_MAKE_PARTIAL_PAYMENTS));
        }
      }
