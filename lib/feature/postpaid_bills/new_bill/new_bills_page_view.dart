    ...
    return Container(
      child: SingleChildScrollView(
        ...
        child: Container(
          ...
          child: AppStreamBuilder<Resource<GetBillCategories>>(
              stream: model.getCategoriesStream,
              initialData: Resource.none(),
              onData: (data){
                model.billCategoriesList = data.data?.getBillCategoriesData?.getBillCategoriesList;
              },
                                  ...
                                  child: SingleChildScrollView(
                                    ...
                                    child: ListView.separated(
                                        ...
                                        itemBuilder: (context, index) {
                                          model.title = model.billCategoriesList?[index].categoryName ?? "";
                                          model.titleIcon = model.billCategoriesList?[index].iconCode ??"";
                                          return InkWell(
                                            onTap: () {
                                        ...
                                        itemCount: model.billCategoriesList!.length),
                                  ),
                                ),
                              ],
                            ))
