...
class CreditCardActivationStatusPage
    extends BasePage<CreditCardActivationStatusPageViewModel> {
  @override
  CreditCardActivationStatusPageState createState() =>
      CreditCardActivationStatusPageState();
}

class CreditCardActivationStatusPageState extends BaseStatefulPage<
    CreditCardActivationStatusPageViewModel, CreditCardActivationStatusPage> {
  @override
