...
import 'confirm_prepaid_bill_payment_amount/confirm_prepaid_bill_payment_amount_page.dart';
import 'pay_prepaid_bill_page_view_model.dart';

class PayPrePaidBillPageView extends BasePageViewWidget<PayPrePaidBillPageViewModel> {
  final pages = [
    PayPrePaidBillDetailPage(),
    ConfirmPrePaidBillPaymentAmountPage(),
  ];

  PayPrePaidBillPageView(ProviderBase model) : super(model);
