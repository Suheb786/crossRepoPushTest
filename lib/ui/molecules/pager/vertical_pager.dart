...
class VerticalPager extends StatefulWidget {
  ...
  @override
  _VerticalPagerState createState() => _VerticalPagerState();
}

class _VerticalPagerState extends State<VerticalPager> {
...
class CardControllerWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < images!.length; i++) {
      ...
      var cardHeight = MediaQuery.of(context).size.height; //getCardHeight(i);
