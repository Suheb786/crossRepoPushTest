          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                  Text(S.of(context).myPostPaidBill, style: TextStyle(fontFamily: StringUtils.appFont, fontSize: 12.0.t, fontWeight: FontWeight.w600, color: AppColor.white)),
                  GestureDetector(
                    onTap: () {
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Text(
                      ...
                      style: TextStyle(fontFamily: StringUtils.appFont, fontSize: 14.0.t, fontWeight: FontWeight.w600, color: AppColor.white),
                    ),
                  ),
                ),
              ),
