...
class DownloadTransactionDialogView extends StatelessWidget {
  ...
  const DownloadTransactionDialogView({this.onDismissed, this.onSelected, this.years, this.onWillPop = true});
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: BaseWidget<DownloadTransactionDialogViewModel>(
