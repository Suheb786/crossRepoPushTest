...
class EVoucherHistoryFilterDialogView extends StatelessWidget {
  final Function? onDismissed;
  final Function(String)? onSelected;
  final String? title;

  EVoucherHistoryFilterDialogView({this.onDismissed, this.onSelected, this.title});
  ...
  Widget build(BuildContext context) {
    return BaseWidget<EVoucherHistoryFilterDialogViewModel>(
      providerBase: providerBase(),
      onModelReady: (model) {},
