...
class YearMonthDialogView extends StatefulWidget {
  ...
  const YearMonthDialogView(
      {this.onDismissed, this.onSelected, this.calendarEnum, this.title, this.onWillPop = true});
...
class _YearMonthDialogViewState extends State<YearMonthDialogView> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async => widget.onWillPop,
      child: BaseWidget<YearMonthDialogViewModel>(
                            ...
                            children: [
                              ...
                              Expanded(
                                  child: listData!.data!.length > 0
                                      ...
                                      : Center(
                                          child: NoDataWidget(
                                            errorMessage: S.of(context).noMatchingYearFound,
                                          ),
                                        )),
                              InkWell(
                                onTap: () {
