        ...
        switch (error.message) {
          ...
          case "err-311":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.NO_DATA_FOUND_IN_FINANCIAL_INSTITUTION);

          case "err-312":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.NO_SUPP_USER_DETAILS_FOUND);

          case "err-322":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.CANNOT_APPLY_CC_INSUFFICIENT_FUNDS);

          case "err-323":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.CANNOT_PROCEED_NO_AHWAL_DATA_FOUND);

          case "err-324":
            return AppError(
                cause: cause, error: error, type: ErrorType.ID_ALREADY_EXISTS);

          case "err-325":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.AHWAL_SERVICE_NOT_AVAILABLE);

          case "err-326":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.LOCATION_RESTRICTED);

          case "err-327":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.ERROR_PHYSICAL_DC_XCS);

          case "err-328":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.ERROR_FOR_PIN_TRANSLATION_XCS);

          case "err-330":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.ERROR_CC_UNBLOCK_NI);

          case "err-331":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.LOGIN_REGISTER_DISABLED);

          case "err-332":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.ERROR_FOR_PIN_CHANGE_NI);
          ...
          case "err-341":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.ERROR_WHILE_GETTING_ALIAS);

          case "err-342":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.ERROR_WHILE_GETTING_ACCOUNT_BY_ALIAS);

          case "err-343":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.ERROR_WHILE_CREATING_AN_ALIAS);

          case "err-344":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.ERROR_WHILE_LINKING_ACCOUNT);

          case "err-345":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.ERROR_WHILE_EDITING_AN_ALIAS);
          case "err-346":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.ERROR_WHILE_TRYING_TO_SUSPEND_AN_ALIAS);
          case "err-347":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.ERROR_WHILE_RE_ACTIVATING_AN_ALIAS);
          case "err-348":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.ERROR_WHILE_DELETING_AN_ALIAS);
          case "err-349":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.ERROR_WHILE_CHANGING_TO_DEFAULT_ACCOUNT);
          case "err-351":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.ERROR_WHILE_UN_LINKING_ACCOUNT);
          case "err-352":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.ERROR_WHILE_REQUESTING_MONEY);
          case "err-353":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.ERROR_WHILE_REQUESTING_MONEY_ACTIVITY);
          case "err-354":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.ERROR_WHILE_UPDATING_RTP_REQUEST);
          case "err-355":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.ERROR_WHILE_SENDING_MONEY_TO_CLIQ_IBAN);
          case "err-366":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.ERROR_WHILE_GETTING_ACCOUNT_BY_CUSTOMER_ID);
          case "err-367":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.ERROR_WHILE_SUBMITTING_OUTWARD_PAYMENT);
          case "err-368":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.ERROR_ON_APPROVE_RTP_REQUEST);
          case "err-369":
            return AppError(
                cause: cause,
                error: error,
          ...
          case "err-370":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.ERROR_ON_REQUEST_TO_PAY_RESULT);
          case "err-371":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.CUSTOMER_OF_INVALID_ALIAS);
          case "err-372":
            return AppError(
                cause: cause, error: error, type: ErrorType.INVALID_IBAN);
          case "err-373":
            return AppError(
                cause: cause, error: error, type: ErrorType.INVALID_ALIAS);
          case "err-374":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.INVALID_MOBILE_NUMBER);
          case "err-376":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.SERVICE_NOT_AVAILABLE);
          ...
          case "err-374":
            return AppError(
                cause: cause,
                error: error,
                type: ErrorType.INVALID_ALIAS_VALUE);
