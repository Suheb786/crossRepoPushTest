    ...
    switch (error.code) {
      ...
      default:
        ...
        switch (error.message) {
          ...
          case "err-341":
            return AppError(cause: cause, error: error, type: ErrorType.ERROR_WHILE_GETTING_ALIAS);

          case "err-342":
            return AppError(cause: cause, error: error, type: ErrorType.ERROR_WHILE_GETTING_ACCOUNT_BY_ALIAS);

          case "err-343":
            return AppError(cause: cause, error: error, type: ErrorType.ERROR_WHILE_CREATING_AN_ALIAS);

          case "err-344":
            return AppError(cause: cause, error: error, type: ErrorType.ERROR_WHILE_LINKING_ACCOUNT);

          case "err-345":
            return AppError(cause: cause, error: error, type: ErrorType.ERROR_WHILE_EDITING_AN_ALIAS);
          case "err-346":
            return AppError(
                cause: cause, error: error, type: ErrorType.ERROR_WHILE_TRYING_TO_SUSPEND_AN_ALIAS);
          case "err-347":
            return AppError(cause: cause, error: error, type: ErrorType.ERROR_WHILE_RE_ACTIVATING_AN_ALIAS);
          case "err-348":
            return AppError(cause: cause, error: error, type: ErrorType.ERROR_WHILE_DELETING_AN_ALIAS);
          case "err-349":
            return AppError(
                cause: cause, error: error, type: ErrorType.ERROR_WHILE_CHANGING_TO_DEFAULT_ACCOUNT);
          case "err-351":
            return AppError(cause: cause, error: error, type: ErrorType.ERROR_WHILE_UN_LINKING_ACCOUNT);
          case "err-352":
            return AppError(cause: cause, error: error, type: ErrorType.ERROR_WHILE_REQUESTING_MONEY);
          case "err-353":
            return AppError(
                cause: cause, error: error, type: ErrorType.ERROR_WHILE_REQUESTING_MONEY_ACTIVITY);
          case "err-354":
            return AppError(cause: cause, error: error, type: ErrorType.ERROR_WHILE_UPDATING_RTP_REQUEST);
          case "err-355":
            return AppError(
