class CustomerStatusEnum {
  ...
  static const CustomerStatusEnum VIDEO_CALL = CustomerStatusEnum._("videoCall");
  static const CustomerStatusEnum SUCCESS = CustomerStatusEnum._("accountSuccess");
  static const CustomerStatusEnum ACCOUNT_PAGE = CustomerStatusEnum._("accountPage");
  static const CustomerStatusEnum DOC_UPLOAD = CustomerStatusEnum._("docupload");
  static const CustomerStatusEnum REMOVE_DEBIT_LOCK = CustomerStatusEnum._("removeDebitLock");
  static const CustomerStatusEnum CARD_ISSUANCE = CustomerStatusEnum._("cardIssuance");
