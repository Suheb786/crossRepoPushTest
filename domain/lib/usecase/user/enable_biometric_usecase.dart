...
class EnableBiometricUseCase extends BaseUseCase<BaseError, EnableBiometricUseCaseParams, bool> {
  final UserRepository _repository;

  EnableBiometricUseCase(this._repository);

  @override
  Future<Either<BaseError, bool>> execute({required EnableBiometricUseCaseParams params}) async {
    return Future.value(
      (await _repository.enableBiometric()).fold((l) => Left(l), (isSuccess) async {
