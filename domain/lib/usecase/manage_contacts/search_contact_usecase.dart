...
class SearchContactUseCase extends BaseUseCase<NetworkError, SearchContactUseCaseParams, BeneficiaryContact> {
  final ManageContactRepository _repository;

  SearchContactUseCase(this._repository);

  @override
  Future<Either<NetworkError, BeneficiaryContact>> execute({required SearchContactUseCaseParams params}) {
