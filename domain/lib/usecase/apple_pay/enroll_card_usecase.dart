...
class EnrollCardUseCase extends BaseUseCase<NetworkError, EnrollCardUseCaseParams, EnrollCardResponse> {
  final ApplePayRepository _repository;

  EnrollCardUseCase(this._repository);

  @override
  Future<Either<NetworkError, EnrollCardResponse>> execute({required EnrollCardUseCaseParams params}) {
