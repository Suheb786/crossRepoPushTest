...
class GetDestinationUseCase extends BaseUseCase<NetworkError, GetDestinationUseCaseParams, bool> {
  final RJRepository _repository;

  GetDestinationUseCase(this._repository);

  @override
  Future<Either<NetworkError, bool>> execute({required GetDestinationUseCaseParams params}) {
