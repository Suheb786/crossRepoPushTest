...
class EVoucherItemFilterUseCase
    extends BaseUseCase<NetworkError, EVoucherItemFilterUseCaseParams, List<VoucherItem>> {
  EVoucherRepository _eVoucherRepository;

  EVoucherItemFilterUseCase(this._eVoucherRepository);

  @override
  Future<Either<NetworkError, List<VoucherItem>>> execute({required EVoucherItemFilterUseCaseParams params}) {
