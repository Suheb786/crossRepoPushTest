...
class GetVoucherDetailUseCase
    extends BaseUseCase<NetworkError, GetVoucherDetailsUseCaseParams, GetVoucherDetails> {
  final EVoucherRepository _eVoucherRepository;

  GetVoucherDetailUseCase(this._eVoucherRepository);

  @override
  Future<Either<NetworkError, GetVoucherDetails>> execute({required GetVoucherDetailsUseCaseParams params}) {
