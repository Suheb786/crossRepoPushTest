...
class EVoucherRegionByCategoriesUseCase
    extends BaseUseCase<BaseError, EVoucherRegionByCategoriesUseCaseParams, List<VoucherRegionByCategories>> {
  EVoucherRepository _eVoucherRepository;

  EVoucherRegionByCategoriesUseCase(this._eVoucherRepository);

  @override
  Future<Either<BaseError, List<VoucherRegionByCategories>>> execute(
