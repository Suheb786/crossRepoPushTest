...
class AddNewPostpaidBillerUseCase extends BaseUseCase<NetworkError, AddNewPostpaidBillerUseCaseParams, bool> {
  final BillPaymentRepository billPaymentRepository;

  AddNewPostpaidBillerUseCase(this.billPaymentRepository);

  @override
  Future<Either<NetworkError, bool>> execute({required AddNewPostpaidBillerUseCaseParams params}) {
...
class AddNewPostpaidBillerUseCaseParams extends Params {
  ...
  AddNewPostpaidBillerUseCaseParams(
      {this.serviceType = "", this.billerCode = "", this.billingNumber = "", this.nickname = ""});
