...
class EditCliqIdUseCase extends BaseUseCase<NetworkError, EditCliqIdUseCaseParams, EditCliq> {
  final CliqRepository _cliqRepository;

  EditCliqIdUseCase(this._cliqRepository);

  @override
  Future<Either<NetworkError, EditCliq>> execute({required EditCliqIdUseCaseParams params}) {
