...
class EmploymentStatusDialogUseCase extends BaseUseCase<LocalError,
    EmploymentStatusDialogUseCaseParams, List<String>> {
  ...
  Future<Either<LocalError, List<String>>> execute(
      {required EmploymentStatusDialogUseCaseParams params}) {
