...
class SubmitOutwardPaymentUseCase extends BaseUseCase<NetworkError,
    SubmitOutwardPaymentUseCaseParamas, bool> {
  final CliqRepository _cliqRepository;
  SubmitOutwardPaymentUseCase(this._cliqRepository);

  @override
  Future<Either<NetworkError, bool>> execute(
      {required SubmitOutwardPaymentUseCaseParamas params}) {
